...
// Simple struct to hold position + yaw
struct PositionYaw
{
    double x, y, z, yaw;
};

// Dynamic Constraints struct
class DynamicConstraints
{
public:
    double max_vel_horz_abs;
...
private:
    ...
    PositionYaw target_position_;
    PositionYaw curr_position_;
    PositionYaw prev_error_;
    PositionYaw curr_error_;
...
#endif /* _PID_POSITION_CONTROLLER_SIMPLE_H_ */
